...
class inconsistency_model(nn.Module):
    def __init__(self,config,pathset):
        ...
        #begin
        self.ln_img = nn.Linear(self.txt_hidden_dim * 2, 200)
        #end
    ...
    #begin
    def forward(self, txt_token, txt_masks, img, kg1, kg2, kg_sim,args,cap_ids,cap_mask):
        img = self.txtenc(cap_ids, cap_mask)
    #end
        #print ('txt_token-----------',txt_token.shape)
        #print ('txt_masks-----------',txt_masks.shape)
        #print ('img--------------',img.shape)
        #print ('kg1------------',kg1.shape)
        #print ('kg2------------',kg2.shape)
        #print ('kg_sim----------',kg_sim.shape)
        #print ('args---------',args)
