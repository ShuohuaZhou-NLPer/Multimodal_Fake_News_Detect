...
class Dataset_all(data.Dataset):
    ...
    #begin
    def __init__(self,x_txt_input_ids,x_txt_attention_masks,x_img,x_kg1,x_kg2,x_kg_sim,y,transform,pathset,x_caption_attention_masks,x_caption_input_ids):
        self.x_caption_mask = x_caption_attention_masks
        self.x_caption_ids = x_caption_input_ids
    #end
    ...
    def __getitem__(self,index):
        ...
        #begin
        return self.data_txt_input_ids[index],self.data_txt_attention_masks[index], image,self.data_kg1[index],self.data_kg2[index],self.data_kg_sim[index],self.label[index],self.x_caption_mask[index],self.x_caption_ids[index]
        #end
    def __len__(self):
